...
const insights = {
    ...
    'wallpapers': "Walls are the canvas of mood. Texture adds depth where color alone falls flat; consider metallic accents for evening elegance.",
    ...
    'upholstery': "Touch is the first sense of comfort. Prioritize tactile richness—velvets for warmth, linens for breathability—to ground the living experience.",
    ...
    'cladding': "Architecture shouldn't stop at the structure. Use cladding to add three-dimensional rhythm to flat facades and feature walls.",
    ...
    'pergola': "Blur the boundary between indoors and out. A pergola isn't just a roof; it's a transition zone that extends your living area into nature.",
